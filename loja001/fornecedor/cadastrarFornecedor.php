  ...
  <main>
    <div>
      <form method="post" action="inclusao.php" enctype="multipart/form-data" class="inputs">
        ...
        <label>Estado Fornecedor:</label>
        <input type="text" name="estadoFornecedor">
        <label>Cidade Fornecedor:</label>
        ...
        <input type="number" name="cnpjFornecedor">
        ...
        <input type="number" name="telFornecedor">
        <label>CEP Fornecedor:</label>
        <input type="number" name="cepFornecedor">
